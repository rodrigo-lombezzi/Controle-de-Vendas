...
function looksLikeJSX(content) {
  // crude heuristic: angle-bracket followed by identifier (component/tag)
...
async function run() {
  ...
  // update imports in whole project (including renamed files)
  console.log('Updating import paths to remove .js/.jsx extensions...');
  // collect files again (include .ts/.tsx and remaining files)
